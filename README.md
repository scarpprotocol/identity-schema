...
- **Requirements paper:** [Universal Participant Identity for the AI-Enabled Economy](https://zenodo.org/records/22867377) defines the fifteen requirements this schema implements. [Website page](https://scarpprotocol.com/insights/identity-paper/).
- **Companion paper:** [Governable AI from the Ground Up: Identity, Cooperation, Governance, and Settlement as Foundational Infrastructure](https://zenodo.org/records/21927017) describes the broader four-layer substrate architecture.
