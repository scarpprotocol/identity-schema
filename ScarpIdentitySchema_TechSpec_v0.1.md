...
This specification implements the fifteen requirements defined in "Universal Participant Identity for the AI-Enabled Economy" (Davidenko, 2026; https://zenodo.org/records/22867377). That paper establishes the requirements through first-principles analysis of autonomous participation scenarios. This specification provides the construction.

Readers unfamiliar with the motivation for governance-enabling identity should consult the requirements paper first (https://scarpprotocol.com/insights/identity-paper/). This specification assumes familiarity with the requirements and focuses on the technical construction that satisfies them.
...
The companion requirements paper (https://zenodo.org/records/22867377) evaluates the current identity standards landscape (including SPIFFE, AIC, AGTP, AAuth, W3C DIDs, and Verifiable Credentials) against the fifteen requirements defined for governance-enabling identity. None of the evaluated standards satisfies the full requirement set. This specification provides the construction that does.
...
- Davidenko, V. (2026). "Universal Participant Identity for the AI-Enabled Economy." https://zenodo.org/records/22867377
- Davidenko, V. (2026). "Governable AI from the Ground Up: Identity, Cooperation, Governance, and Settlement as Foundational Infrastructure." https://zenodo.org/records/21927017
